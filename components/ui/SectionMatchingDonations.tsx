  ...
  return (
    <div className="text-center">
      ...
      <p className="mb-6 text-[16px] text-[#000000]">
        ...
        <strong>$1.25 million</strong>! This means your donation will have double
        the impact.
      </p>
      <div className="flex flex-col items-center justify-center gap-4 md:flex-row">
        ...
        <div className="flex-1">
          ...
          <p className="markdown text-[16px] text-[#000000]">
            ...
            print money for ourselves. So because of that the Litecoin Foundation
            is very lean. Most projects that come to us we have to turn down
            because we don't have the funding. I want to change that." -{' '}
            <em>Charlie Lee</em>
          </p>
        </div>
      </div>
